...
function ChatAnalysis(){
  ...
  return (<div className="fade">
    <PageHeader title={t("nav_chat")} sub={L("Ask about the SAMA +50bps shock → size the Seg-A gap → design the closure plan & actions → human gate → push as SSOT data to DSS (fund size / funding gap / gap-filling owned by DSS, not DSO)","就 SAMA +50bps 冲击提问 → 量化 A 段供需缺口 → 给出闭合方案与执行动作 → 人工门复核 → 作为 SSOT 数据推送给 DSS(资金体量 / 缺口 / 补缺方案归 DSS,不在 DSO 范围)")} cls="ph-end"
      right={mafChip}/>
