...
Object.assign(I18N.en, {
  ...
  ki_snapshot:"Snapshot · Jun 1, 2026", ki_sub:"Key indicators — monthly snapshot", ki_real:"Real data", ki_mock:"DSO estimate",
...
Object.assign(I18N.zh, {
  ...
  ki_snapshot:"快照 · 2026 年 6 月 1 日", ki_sub:"关键指标 — 月度快照", ki_real:"真实数据", ki_mock:"DSO 估算",
...
Object.assign(I18N.ar, {
  ...
  ki_snapshot:"لقطة · ١ يونيو ٢٠٢٦", ki_sub:"المؤشرات الرئيسية — لقطة شهرية", ki_real:"بيانات حقيقية", ki_mock:"تقدير DSO",
...
const KI_KPI=[
  ...
  {src:"DSO · Conversion (AUC 0.83)", src_zh:"DSO · 转化(AUC 0.83)", real:0, label:"Avg. Project Conversion", label_zh:"平均项目转化率", v:"65.8", unit:"%", chg:"↓ 1.4pp", cTone:"bad", color:"#f59e0b",
...
const KI_SCN=[
  ...
  {k:"base",prob:55, tone:"blue", active:1, rate:"Hold at 4.25%", rate_zh:"维持 4.25%", gdp:"GDP 2.8%"},
...
function Hub(){
  const {t,lang,user,setRoute,cov}=useStore();
    ...
    <div className="cols-2">
      <Section title={t("ki_scn_title")}>
        <div className="ki-scn">{KI_SCN.map(s=>(<div key={s.k} className={"ki-scn-box "+s.tone+(s.active?" active":"")}>
          ...
          <div className="n">{t("sc_"+s.k)}{s.active?(" ← "+t("ki_active")):""}</div>
        ...
        <div className="muted" style={{fontSize:11,marginTop:8}}>{t("ki_scn_note")}</div>
      </Section>
